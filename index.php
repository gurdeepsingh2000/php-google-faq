...
$paragraphs = [
    ...
    [
        ...
        "answer" => "We know security and privacy are important to you – and they are important to us, too. We make it a priority to provide strong security and give you confidence that your information is safe and accessible when you need it. <p>
        ...
        You can learn more about safety and security online, including how to protect yourself and your family online, at the <a href=\"https://www.google.com/safetycenter\">Google Safety Center</a>. <p>
        
        <a href=\"https://privacy.google.com\">Learn more</a> about how we keep your personal information private and safe — and put you in control. <p>"
    ],
    [
        ...
        "answer" => "Your account is associated with a country (or territory) in the Terms of Service so that we can determine two things:
            ...
            <h3 class='sub-paragraph'>Determining the country associated with your account</h3>
...
<div class="main">
    <div class="text-container">
        ...
        foreach($paragraphs as $element){?>
            ...
            <p class = "answer"><?php echo "{$element['answer']}"?></p>
            <?php
        }
    ?>
</div>
